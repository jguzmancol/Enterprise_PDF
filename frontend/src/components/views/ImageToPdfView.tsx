...
export default function ImageToPdfView() {
  ...
  return (
    <div>
      <h2 className="text-lg font-semibold mb-3 dark:text-gray-100">Image to PDF</h2>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
        Convert one or more images (PNG, JPEG, WebP, BMP, TIFF) to a single
      ...
      {loading && (
        <p className="text-sm text-blue-600 mt-3">Converting...</p>
      )}

      {downloadId && (
        <div className="mt-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          <p className="text-green-700 dark:text-green-300 text-sm mb-2">Conversion complete!</p>
            <a
