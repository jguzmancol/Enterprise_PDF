...
export default function FileDropzone({ onUpload, accept = ".pdf", label = "Drag & drop PDF files here, or click to browse", hint = "Max 100 MB per file", }) {
