...
export default function Layout({ files, onUpload, error, onClearFiles, thumbnailSize, onThumbnailSizeChange, useSharedFiles, onToggleSharedFiles, multiple = true, children, }) {
